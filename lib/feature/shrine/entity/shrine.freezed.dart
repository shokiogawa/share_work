...
Shrine _$ShrineFromJson(Map<String, dynamic> json) {
  return _Shrine.fromJson(json);
}
...
mixin _$Shrine {
  ...
  @JsonKey(ignore: true)
  $ShrineCopyWith<Shrine> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ShrineCopyWith<$Res> {
  factory $ShrineCopyWith(Shrine value, $Res Function(Shrine) then) =
      _$ShrineCopyWithImpl<$Res, Shrine>;
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class _$ShrineCopyWithImpl<$Res, $Val extends Shrine>
    implements $ShrineCopyWith<$Res> {
  _$ShrineCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ShrineImplCopyWith<$Res> implements $ShrineCopyWith<$Res> {
  factory _$$ShrineImplCopyWith(
          _$ShrineImpl value, $Res Function(_$ShrineImpl) then) =
      __$$ShrineImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$ShrineImplCopyWithImpl<$Res>
    extends _$ShrineCopyWithImpl<$Res, _$ShrineImpl>
    implements _$$ShrineImplCopyWith<$Res> {
  __$$ShrineImplCopyWithImpl(
      _$ShrineImpl _value, $Res Function(_$ShrineImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$ShrineImpl extends _Shrine {
  const _$ShrineImpl(
      {required this.id,
  ...
  factory _$ShrineImpl.fromJson(Map<String, dynamic> json) =>
      _$$ShrineImplFromJson(json);
  ...
  @override
  String toString() {
    return 'Shrine(id: $id, idPlace: $idPlace, name: $name, areaName: $areaName, ruby: $ruby, latitude: $latitude, longitude: $longitude, typeRegisterStamp: $typeRegisterStamp, url: $url, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ShrineImplCopyWith<_$ShrineImpl> get copyWith =>
      __$$ShrineImplCopyWithImpl<_$ShrineImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ShrineImplToJson(
      this,
    );
  }
}

abstract class _Shrine extends Shrine {
  const factory _Shrine(
      ...
      _$ShrineImpl;
  const _Shrine._() : super._();

  factory _Shrine.fromJson(Map<String, dynamic> json) = _$ShrineImpl.fromJson;
